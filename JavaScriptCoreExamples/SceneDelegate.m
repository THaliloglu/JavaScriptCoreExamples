...
//
//    // Getting value from JS context
//    JSValue *result = [context evaluateScript:@"2+2"];
//    NSLog(@"Result is : %@", [result toString]);
//
//    // Declare a function using block and run via JS context
//    context[@"selfLog"] = ^(NSString *message){
//        NSLog(@"%@",message);
//    };
//    [context evaluateScript:@"selfLog('Hello World!!!')"];
    
    
//    JSContext *context = [[JSContext alloc] init];
//
//    // Load your class to Context
//    context[@"Console"] = [Console class];
//
//    // Run js code from text format
